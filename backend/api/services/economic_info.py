...
class EconomicInfo():
    ...
    def interpret_data(self, fred_info, market_data):
        ...
        prompt = f"Analyze the provided market data and give a concise overall summary on the current state of the US markets and how its trending based on the data. Here is the market data {market_data}"
        response = model.generate_content(prompt)
        economic_health_prompt = f"Analyze the provided data and give a concise overall summary on the current state of the US Economy and how its trending based on the data, here's the data {fred_info}"
